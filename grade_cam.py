...
def grad_cam(input_model, image, cls, layer_name, alp=0.05):
...
def compute_saliency(model, guided_model, img_path, layer_name='block5_conv3', cls=-1, visualize=True, save=True, alp=0.05):
    ...
    if save:
        ...
        cv2.imwrite('Images_test/gradcam.jpg', np.uint8(jetcam))
        cv2.imwrite('Images_test/guided_backprop.jpg', deprocess_image(gb[0]))
        cv2.imwrite('Images_test/guided_gradcam.jpg', deprocess_image(guided_gradcam[0]))
...
if __name__ == '__main__':
    ...
    for f_name in os.listdir(base_path):
        ...
        gradcam, gb, guided_gradcam = compute_saliency(model, guided_model, layer_name='block5_conv3',
                                                 img_path=img_path, cls=-1, visualize=True, save=True)
